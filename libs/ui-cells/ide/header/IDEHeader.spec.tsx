...
jest.mock('@ktn/ui-molecules', () => ({
  ...
  IDEHeaderMenuBar: () => <div data-testid="header-menu-bar">MenuBar</div>,
}))
...
describe('IDEHeader', () => {
  ...
  it('should not render menu bar when enableMenuBar is false', () => {
    render(<IDEHeader enableMenuBar={false} />)

    expect(screen.queryByTestId('header-menu-bar')).not.toBeInTheDocument()
  })

  it('should render menu bar when enableMenuBar is true', () => {
    render(<IDEHeader enableMenuBar={true} />)
